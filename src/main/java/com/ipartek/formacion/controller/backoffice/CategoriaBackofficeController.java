...
public class CategoriaBackofficeController extends HttpServlet {
	...
	/**
	 * recoge los datos del formulario y los guarda en la base datos. Nos sirve tanto para crear una categoria como para modificarla
	 * 
	 * 1) recoger parametro del formulario 2) validar que sean correctos 3) guardar en la bbdd
	 * 
	 * 
	 */
